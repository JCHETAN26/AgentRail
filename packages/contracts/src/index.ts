...
export type BaselineReportRef = Schemas['BaselineReportRef'];
export type MetricDelta = Schemas['MetricDeltaResponse'];
export type MetricDeltaStatus = Schemas['MetricDeltaStatus'];
